...
const ProjectDetails = ({ project, selectedDate, setSelectedDate, fileUploads, filter, setFilter, events }) => {
  ...
  return (
    <VStack spacing={6} align="stretch">
      ...
      <Breadcrumb.Root mb={2}>
        <Breadcrumb.List>
          <Breadcrumb.Item>
            <Breadcrumb.Link href="/admin-dashboard/projects">
              My Projects
            </Breadcrumb.Link>
          </Breadcrumb.Item>
        ...
        <Card.Root w="100%" position="relative" mt={10} borderRadius="lg" overflow="hidden">
          ...
          >
            ...
            <Text fontSize="md" color="gray.300" mb={4}>
              {project.location || "Madrid, Lisbon"}
            </Text>
      ...
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
        <Stat.Root p={4} borderWidth="1px" borderRadius="lg" boxShadow="sm">
          <HStack spacing={4} mb={3}>
            <Users size={20} />
            <Stat.Label fontWeight="bold">Contractors</Stat.Label>
          </HStack>
          <Stat.ValueText fontSize="2xl">{project.contractors.length}</Stat.ValueText>
          <Stat.HelpText>Active on project</Stat.HelpText>
        </Stat.Root>

        <Stat.Root p={4} borderWidth="1px" borderRadius="lg" boxShadow="sm">
          <HStack spacing={4} mb={3}>
            <Building2 size={20} />
            <Stat.Label fontWeight="bold">Project Phase</Stat.Label>
          </HStack>
          <Stat.ValueText fontSize="2xl">Construction</Stat.ValueText>
          <Stat.HelpText>In progress</Stat.HelpText>
        </Stat.Root>

        <Stat.Root p={4} borderWidth="1px" borderRadius="lg" boxShadow="sm">
          <HStack spacing={4} mb={3}>
            <Star size={20} />
            <Stat.Label fontWeight="bold">Feedback Score</Stat.Label>
          </HStack>
          <Stat.ValueText fontSize="2xl">4.5/5</Stat.ValueText>
          <Stat.HelpText>Based on consultant reviews</Stat.HelpText>
        </Stat.Root>
      </SimpleGrid>

      {/* Contractor Management Section */}
      <Box mt={8}>
        <Heading size="lg" mb={4}>Contractor Management</Heading>
                ...
                <Menu.Root>
                  ...
                  <Portal>
                    <Menu.Content>
                      ...
                      <Menu.Item>View Documents</Menu.Item>
                    </Menu.Content>
                  </Portal>
                </Menu.Root>
              </HStack>
      ...
      <Box mt={8}>
        <Heading size="lg" mb={4}>Consultant Feedback</Heading>
        <Timeline.Root>
          {project.consultantFeedback.map((feedback, idx) => (
    ...
    if (id) {
      const projects = [
        ...
        { 
          ...
          description: "Luxury apartments in the city.",
